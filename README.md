...
# Important: current branch implements new Data Grid native indexing annotations, so only works correctly on Data Grid 8.4.0+. For previus Data Grid versions refers branch "openshift" 
