...
# Important: current branch implements [new Data Grid native indexing annotations](https://github.com/alexbarbosa1989/dg8remote#changes-summary), so only works correctly on Data Grid 8.4.0+. For previus Data Grid versions refers the current repository branch [openshift](https://github.com/alexbarbosa1989/dg8remote/tree/openshift) 
